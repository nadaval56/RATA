/* ================= פרטיות =================
   ...
   הקובץ נטען ראשון בכל דף, לפני storage.js ולפני a11y.js, כדי
   שהדגל יהיה זמין להם. אין כאן שום שליחה של מידע לשום מקום —
   האתר כולו סטטי, וכל מה שנוגע בו לא עוזב את הדפדפן.
...
const APP_PREFIXES = ['altimeter:', 'a11y:'];
    ...
    bar.innerHTML =
      '<div class="wrap">' +
        '<div class="consent-txt">' +
          '<b>הודעת פרטיות</b>' +
          '<p>האתר לא אוסף עליך מידע, לא משתמש בעוגיות ולא מעביר דבר לצד שלישי. ' +
          'ההתקדמות בלימוד והעדפות התצוגה נשמרות <b>במכשיר שלך בלבד</b> (אחסון מקומי בדפדפן) ' +
          'ואינן נשלחות לשום שרת. ' +
          '<a href="' + base + 'privacy/">מדיניות הפרטיות המלאה</a></p>' +
        '</div>' +
